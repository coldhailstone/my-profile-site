    ...
    career: [
        {
            ...
            projects: [
                {
                    name: '삼성생명 사랑On App 유지보수',
                    period: '2024.01 ~ 현재',
                    skills: ['Vue.js', 'Java', 'Anyframe', 'Oracle', 'SVN', 'Sparrow'],
                },
            ],
        },
        {
            ...
            projects: [
                {
                    name: '랩매니저 Pro 사용성 개선',
                    period: '2023.02 ~ 2023.04',
                    skills: ['Vue.js', 'SCSS', 'Git', 'Jira', 'Figma'],
                },
                {
                    name: '랩매니저 서치 개발',
        ...
        },
        {
            ...
            projects: [
                {
                    name: '오늘의집 콜센터 CTI 프로그램 개발',
                    period: '2021.01 ~ 2021.07',
                    skills: ['Vue.js', 'Java', 'Spring', 'Oracle', 'SVN', 'Jira'],
                },
                {
                    name: 'OK 저축은행 콜센터 CTI 프로그램 유지보수',
                    period: '2020.05 ~ 2020.12',
                    skills: ['JavaScript', 'Java', 'MiPlatform', 'Oracle'],
                },
                {
                    name: '성부산업 자율주행 농기계 관리 프로그램 개발',
                ...
                {
                    name: '하나은행 인공지능 AI챗봇 서비스 하이(HAI) 3차 고도화',
                    period: '2019.01 ~ 2019.08',
                    skills: ['JQuery', 'Java', 'Spring', 'Oracle', 'SVN', 'Jira'],
                },
                {
                    name: '위컴즈 콜센터 CTI 솔루션(EWM) 개발',
                ...
                {
                    name: '하나은행 인공지능 AI챗봇 서비스 하이(HAI) 2차 고도화',
                    period: '2018.03 ~ 2018.08',
                    skills: ['JQuery', 'Java', 'Spring', 'Oracle', 'SVN', 'Jira'],
                },
                {
                    name: '한국투자증권 콜센터 CTI 프로그램 개발',
                    period: '2017.11 ~ 2018.03',
                    skills: ['JQuery', 'SVN', 'Jira'],
                },
            ],
        },
        {
